...
class _Step2AddressState extends State<Step2Address> {
  ...
  void initState() {
    ...
    _villageCtrl = TextEditingController(text: widget.student.village);
    _districtCtrl = TextEditingController(text: widget.student.district);
    _pinCtrl = TextEditingController(text: widget.student.pin);
    _mobile1Ctrl = TextEditingController(text: widget.student.mobileNo1);
    _mobile2Ctrl = TextEditingController(text: widget.student.mobileNo2);
  }
      ...
      child: ListView(
        ...
        children: [
          ...
          TextFormField(
            ...
            onChanged: (v) => widget.student.address = v,
          ),
          TextFormField(
            decoration: InputDecoration(label: Text('Village / Town')),
            controller: _villageCtrl,
            onChanged: (v) => widget.student.village = v,
          ),
          ...
          TextFormField(
            ...
            onChanged: (v) => widget.student.district = v,
          ),

          FormDropdown(
            label: 'State',
            value: widget.student.state,
            isRequired: true,
            items: _indianStates,
            validator: (v) =>
                v == null || v.isEmpty ? 'State is required' : null,
            onChanged: (v) => setState(() => widget.student.state = v ?? ''),
          ),
          ...
          TextFormField(
            ...
            onChanged: (v) => widget.student.pin = v,
          ),
          ...
          TextFormField(
            ...
            onChanged: (v) => widget.student.mobileNo1 = v,
          ),
          ...
          TextFormField(
            ...
            onChanged: (v) => widget.student.mobileNo2 = v,
          ),
